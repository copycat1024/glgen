...
pub fn bind_buffer_range(&self, target: enums::BufferTargetARB, index: u32, buffer: u32, offset: isize, size: isize) {
...
pub fn bind_image_texture(&self, unit: u32, texture: u32, level: i32, layered: enums::Boolean, layer: i32, access: enums::BufferAccessARB, format: enums::InternalFormat) {
(self.bind_image_texture_p)(unit, texture, level, layered as u8, layer, access as u32, format as u32)
}
...
pub fn blend_equation_separate(&self, mode_r_g_b: enums::BlendEquationModeEXT, mode_alpha: enums::BlendEquationModeEXT) {
(self.blend_equation_separate_p)(mode_r_g_b as u32, mode_alpha as u32)
}

pub fn blend_equation_separatei(&self, buf: u32, mode_r_g_b: enums::BlendEquationModeEXT, mode_alpha: enums::BlendEquationModeEXT) {
...
pub fn blend_func_separate(&self, sfactor_r_g_b: enums::BlendingFactor, dfactor_r_g_b: enums::BlendingFactor, sfactor_alpha: enums::BlendingFactor, dfactor_alpha: enums::BlendingFactor) {
(self.blend_func_separate_p)(sfactor_r_g_b as u32, dfactor_r_g_b as u32, sfactor_alpha as u32, dfactor_alpha as u32)
}

pub fn blend_func_separatei(&self, buf: u32, src_r_g_b: enums::BlendingFactor, dst_r_g_b: enums::BlendingFactor, src_alpha: enums::BlendingFactor, dst_alpha: enums::BlendingFactor) {
(self.blend_func_separatei_p)(buf, src_r_g_b as u32, dst_r_g_b as u32, src_alpha as u32, dst_alpha as u32)
}
...
pub fn blit_framebuffer(&self, src_x0: i32, src_y0: i32, src_x1: i32, src_y1: i32, dst_x0: i32, dst_y0: i32, dst_x1: i32, dst_y1: i32, mask: enums::ClearBufferMask, filter: enums::BlitFramebufferFilter) {
(self.blit_framebuffer_p)(src_x0, src_y0, src_x1, src_y1, dst_x0, dst_y0, dst_x1, dst_y1, mask as u32, filter as u32)
}

pub fn buffer_data(&self, target: enums::BufferTargetARB, size: isize, data: *const c_void, usage: enums::BufferUsageARB) {
(self.buffer_data_p)(target as u32, size, data, usage as u32)
}

pub fn buffer_sub_data(&self, target: enums::BufferTargetARB, offset: isize, size: isize, data: *const c_void) {
(self.buffer_sub_data_p)(target as u32, offset, size, data)
}

pub fn check_framebuffer_status(&self, target: enums::FramebufferTarget) -> enums::FramebufferStatus {
...
pub fn client_wait_sync(&self, sync: *mut c_void, flags: enums::SyncObjectMask, timeout: u64) -> enums::SyncStatus {
...
pub fn color_mask(&self, red: enums::Boolean, green: enums::Boolean, blue: enums::Boolean, alpha: enums::Boolean) {
(self.color_mask_p)(red as u8, green as u8, blue as u8, alpha as u8)
}

pub fn color_maski(&self, index: u32, r: enums::Boolean, g: enums::Boolean, b: enums::Boolean, a: enums::Boolean) {
...
pub fn color_pointer(&self, size: i32, type_: enums::ColorPointerType, stride: i32, pointer: *const c_void) {
...
pub fn compressed_tex_image1_d(&self, target: enums::TextureTarget, level: i32, internalformat: enums::InternalFormat, width: i32, border: i32, image_size: i32, data: *const c_void) {
(self.compressed_tex_image1_d_p)(target as u32, level, internalformat as u32, width, border, image_size, data)
}

pub fn compressed_tex_image2_d(&self, target: enums::TextureTarget, level: i32, internalformat: enums::InternalFormat, width: i32, height: i32, border: i32, image_size: i32, data: *const c_void) {
(self.compressed_tex_image2_d_p)(target as u32, level, internalformat as u32, width, height, border, image_size, data)
}

pub fn compressed_tex_image3_d(&self, target: enums::TextureTarget, level: i32, internalformat: enums::InternalFormat, width: i32, height: i32, depth: i32, border: i32, image_size: i32, data: *const c_void) {
(self.compressed_tex_image3_d_p)(target as u32, level, internalformat as u32, width, height, depth, border, image_size, data)
}

pub fn compressed_tex_sub_image1_d(&self, target: enums::TextureTarget, level: i32, xoffset: i32, width: i32, format: enums::InternalFormat, image_size: i32, data: *const c_void) {
(self.compressed_tex_sub_image1_d_p)(target as u32, level, xoffset, width, format as u32, image_size, data)
}

pub fn compressed_tex_sub_image2_d(&self, target: enums::TextureTarget, level: i32, xoffset: i32, yoffset: i32, width: i32, height: i32, format: enums::InternalFormat, image_size: i32, data: *const c_void) {
(self.compressed_tex_sub_image2_d_p)(target as u32, level, xoffset, yoffset, width, height, format as u32, image_size, data)
}

pub fn compressed_tex_sub_image3_d(&self, target: enums::TextureTarget, level: i32, xoffset: i32, yoffset: i32, zoffset: i32, width: i32, height: i32, depth: i32, format: enums::InternalFormat, image_size: i32, data: *const c_void) {
(self.compressed_tex_sub_image3_d_p)(target as u32, level, xoffset, yoffset, zoffset, width, height, depth, format as u32, image_size, data)
}

pub fn copy_buffer_sub_data(&self, read_target: enums::CopyBufferSubDataTarget, write_target: enums::CopyBufferSubDataTarget, read_offset: isize, write_offset: isize, size: isize) {
(self.copy_buffer_sub_data_p)(read_target as u32, write_target as u32, read_offset, write_offset, size)
}

pub fn copy_image_sub_data(&self, src_name: u32, src_target: enums::CopyImageSubDataTarget, src_level: i32, src_x: i32, src_y: i32, src_z: i32, dst_name: u32, dst_target: enums::CopyImageSubDataTarget, dst_level: i32, dst_x: i32, dst_y: i32, dst_z: i32, src_width: i32, src_height: i32, src_depth: i32) {
(self.copy_image_sub_data_p)(src_name, src_target as u32, src_level, src_x, src_y, src_z, dst_name, dst_target as u32, dst_level, dst_x, dst_y, dst_z, src_width, src_height, src_depth)
}

pub fn copy_tex_image1_d(&self, target: enums::TextureTarget, level: i32, internalformat: enums::InternalFormat, x: i32, y: i32, width: i32, border: i32) {
(self.copy_tex_image1_d_p)(target as u32, level, internalformat as u32, x, y, width, border)
}

pub fn copy_tex_image2_d(&self, target: enums::TextureTarget, level: i32, internalformat: enums::InternalFormat, x: i32, y: i32, width: i32, height: i32, border: i32) {
(self.copy_tex_image2_d_p)(target as u32, level, internalformat as u32, x, y, width, height, border)
}

pub fn copy_tex_sub_image1_d(&self, target: enums::TextureTarget, level: i32, xoffset: i32, x: i32, y: i32, width: i32) {
(self.copy_tex_sub_image1_d_p)(target as u32, level, xoffset, x, y, width)
}

pub fn copy_tex_sub_image2_d(&self, target: enums::TextureTarget, level: i32, xoffset: i32, yoffset: i32, x: i32, y: i32, width: i32, height: i32) {
(self.copy_tex_sub_image2_d_p)(target as u32, level, xoffset, yoffset, x, y, width, height)
}

pub fn copy_tex_sub_image3_d(&self, target: enums::TextureTarget, level: i32, xoffset: i32, yoffset: i32, zoffset: i32, x: i32, y: i32, width: i32, height: i32) {
(self.copy_tex_sub_image3_d_p)(target as u32, level, xoffset, yoffset, zoffset, x, y, width, height)
}
...
pub fn create_shader_programv(&self, type_: enums::ShaderType, count: i32, strings: *const *const i8) -> u32 {
...
pub fn debug_message_control(&self, source: enums::DebugSource, type_: enums::DebugType, severity: enums::DebugSeverity, count: i32, ids: *const u32, enabled: enums::Boolean) {
(self.debug_message_control_p)(source as u32, type_ as u32, severity as u32, count, ids, enabled as u8)
}

pub fn debug_message_insert(&self, source: enums::DebugSource, type_: enums::DebugType, id: u32, severity: enums::DebugSeverity, length: i32, buf: *const i8) {
(self.debug_message_insert_p)(source as u32, type_ as u32, id, severity as u32, length, buf)
}
...
pub fn depth_mask(&self, flag: enums::Boolean) {
...
pub fn draw_arrays_instanced(&self, mode: enums::PrimitiveType, first: i32, count: i32, instancecount: i32) {
...
pub fn draw_elements(&self, mode: enums::PrimitiveType, count: i32, type_: enums::DrawElementsType, indices: *const c_void) {
(self.draw_elements_p)(mode as u32, count, type_ as u32, indices)
}

pub fn draw_elements_base_vertex(&self, mode: enums::PrimitiveType, count: i32, type_: enums::DrawElementsType, indices: *const c_void, basevertex: i32) {
(self.draw_elements_base_vertex_p)(mode as u32, count, type_ as u32, indices, basevertex)
}

pub fn draw_elements_indirect(&self, mode: enums::PrimitiveType, type_: enums::DrawElementsType, indirect: *const c_void) {
(self.draw_elements_indirect_p)(mode as u32, type_ as u32, indirect)
}

pub fn draw_elements_instanced(&self, mode: enums::PrimitiveType, count: i32, type_: enums::DrawElementsType, indices: *const c_void, instancecount: i32) {
(self.draw_elements_instanced_p)(mode as u32, count, type_ as u32, indices, instancecount)
}

pub fn draw_elements_instanced_base_vertex(&self, mode: enums::PrimitiveType, count: i32, type_: enums::DrawElementsType, indices: *const c_void, instancecount: i32, basevertex: i32) {
(self.draw_elements_instanced_base_vertex_p)(mode as u32, count, type_ as u32, indices, instancecount, basevertex)
}

pub fn draw_range_elements(&self, mode: enums::PrimitiveType, start: u32, end: u32, count: i32, type_: enums::DrawElementsType, indices: *const c_void) {
(self.draw_range_elements_p)(mode as u32, start, end, count, type_ as u32, indices)
}

pub fn draw_range_elements_base_vertex(&self, mode: enums::PrimitiveType, start: u32, end: u32, count: i32, type_: enums::DrawElementsType, indices: *const c_void, basevertex: i32) {
(self.draw_range_elements_base_vertex_p)(mode as u32, start, end, count, type_ as u32, indices, basevertex)
}
...
pub fn fence_sync(&self, condition: enums::SyncCondition, flags: enums::SyncBehaviorFlags) -> *mut c_void {
...
pub fn flush_mapped_buffer_range(&self, target: enums::BufferTargetARB, offset: isize, length: isize) {
...
pub fn framebuffer_parameteri(&self, target: enums::FramebufferTarget, pname: enums::FramebufferParameterName, param: i32) {
(self.framebuffer_parameteri_p)(target as u32, pname as u32, param)
}

pub fn framebuffer_renderbuffer(&self, target: enums::FramebufferTarget, attachment: enums::FramebufferAttachment, renderbuffertarget: enums::RenderbufferTarget, renderbuffer: u32) {
(self.framebuffer_renderbuffer_p)(target as u32, attachment as u32, renderbuffertarget as u32, renderbuffer)
}

pub fn framebuffer_texture(&self, target: enums::FramebufferTarget, attachment: enums::FramebufferAttachment, texture: u32, level: i32) {
(self.framebuffer_texture_p)(target as u32, attachment as u32, texture, level)
}

pub fn framebuffer_texture1_d(&self, target: enums::FramebufferTarget, attachment: enums::FramebufferAttachment, textarget: enums::TextureTarget, texture: u32, level: i32) {
(self.framebuffer_texture1_d_p)(target as u32, attachment as u32, textarget as u32, texture, level)
}

pub fn framebuffer_texture2_d(&self, target: enums::FramebufferTarget, attachment: enums::FramebufferAttachment, textarget: enums::TextureTarget, texture: u32, level: i32) {
(self.framebuffer_texture2_d_p)(target as u32, attachment as u32, textarget as u32, texture, level)
}

pub fn framebuffer_texture3_d(&self, target: enums::FramebufferTarget, attachment: enums::FramebufferAttachment, textarget: enums::TextureTarget, texture: u32, level: i32, zoffset: i32) {
(self.framebuffer_texture3_d_p)(target as u32, attachment as u32, textarget as u32, texture, level, zoffset)
}

pub fn framebuffer_texture_layer(&self, target: enums::FramebufferTarget, attachment: enums::FramebufferAttachment, texture: u32, level: i32, layer: i32) {
...
pub fn get_active_attrib(&self, program: u32, index: u32, buf_size: i32, length: *mut i32, size: *mut i32, type_: *mut enums::AttributeType, name: *mut i8) {
(self.get_active_attrib_p)(program, index, buf_size, length, size, type_ as *mut u32, name)
}

pub fn get_active_uniform(&self, program: u32, index: u32, buf_size: i32, length: *mut i32, size: *mut i32, type_: *mut enums::UniformType, name: *mut i8) {
(self.get_active_uniform_p)(program, index, buf_size, length, size, type_ as *mut u32, name)
}
...
pub fn get_active_uniform_blockiv(&self, program: u32, uniform_block_index: u32, pname: enums::UniformBlockPName, params: *mut i32) {
...
pub fn get_active_uniformsiv(&self, program: u32, uniform_count: i32, uniform_indices: *const u32, pname: enums::UniformPName, params: *mut i32) {
(self.get_active_uniformsiv_p)(program, uniform_count, uniform_indices, pname as u32, params)
}
...
pub fn get_booleani_v(&self, target: enums::BufferTargetARB, index: u32, data: *mut enums::Boolean) {
(self.get_booleani_v_p)(target as u32, index, data as *mut u8)
}

pub fn get_booleanv(&self, pname: enums::GetPName, data: *mut enums::Boolean) {
(self.get_booleanv_p)(pname as u32, data as *mut u8)
}

pub fn get_buffer_parameteri64v(&self, target: enums::BufferTargetARB, pname: enums::BufferPNameARB, params: *mut i64) {
(self.get_buffer_parameteri64v_p)(target as u32, pname as u32, params)
}

pub fn get_buffer_parameteriv(&self, target: enums::BufferTargetARB, pname: enums::BufferPNameARB, params: *mut i32) {
(self.get_buffer_parameteriv_p)(target as u32, pname as u32, params)
}

pub fn get_buffer_pointerv(&self, target: enums::BufferTargetARB, pname: enums::BufferPointerNameARB, params: *mut *mut c_void) {
(self.get_buffer_pointerv_p)(target as u32, pname as u32, params)
}

pub fn get_buffer_sub_data(&self, target: enums::BufferTargetARB, offset: isize, size: isize, data: *mut c_void) {
...
pub fn get_compressed_tex_image(&self, target: enums::TextureTarget, level: i32, img: *mut c_void) {
(self.get_compressed_tex_image_p)(target as u32, level, img)
}

pub fn get_debug_message_log(&self, count: u32, buf_size: i32, sources: *mut enums::DebugSource, types: *mut enums::DebugType, ids: *mut u32, severities: *mut enums::DebugSeverity, lengths: *mut i32, message_log: *mut i8) -> u32 {
(self.get_debug_message_log_p)(count, buf_size, sources as *mut u32, types as *mut u32, ids, severities as *mut u32, lengths, message_log)
}
...
pub fn get_framebuffer_attachment_parameteriv(&self, target: enums::FramebufferTarget, attachment: enums::FramebufferAttachment, pname: enums::FramebufferAttachmentParameterName, params: *mut i32) {
(self.get_framebuffer_attachment_parameteriv_p)(target as u32, attachment as u32, pname as u32, params)
}

pub fn get_framebuffer_parameteriv(&self, target: enums::FramebufferTarget, pname: enums::FramebufferAttachmentParameterName, params: *mut i32) {
...
pub fn get_internalformativ(&self, target: enums::TextureTarget, internalformat: enums::InternalFormat, pname: enums::InternalFormatPName, count: i32, params: *mut i32) {
(self.get_internalformativ_p)(target as u32, internalformat as u32, pname as u32, count, params)
}

pub fn get_lightfv(&self, light: enums::LightName, pname: enums::LightParameter, params: *mut f32) {
(self.get_lightfv_p)(light as u32, pname as u32, params)
}

pub fn get_lightxv(&self, light: enums::LightName, pname: enums::LightParameter, params: *mut i32) {
(self.get_lightxv_p)(light as u32, pname as u32, params)
}

pub fn get_materialfv(&self, face: enums::TriangleFace, pname: enums::MaterialParameter, params: *mut f32) {
(self.get_materialfv_p)(face as u32, pname as u32, params)
}

pub fn get_materialxv(&self, face: enums::TriangleFace, pname: enums::MaterialParameter, params: *mut i32) {
(self.get_materialxv_p)(face as u32, pname as u32, params)
}

pub fn get_multisamplefv(&self, pname: enums::GetMultisamplePNameNV, index: u32, val: *mut f32) {
(self.get_multisamplefv_p)(pname as u32, index, val)
}

pub fn get_object_label(&self, identifier: enums::ObjectIdentifier, name: u32, buf_size: i32, length: *mut i32, label: *mut i8) {
...
pub fn get_program_interfaceiv(&self, program: u32, program_interface: enums::ProgramInterface, pname: enums::ProgramInterfacePName, params: *mut i32) {
...
pub fn get_program_pipelineiv(&self, pipeline: u32, pname: enums::PipelineParameterName, params: *mut i32) {
(self.get_program_pipelineiv_p)(pipeline, pname as u32, params)
}

pub fn get_program_resource_index(&self, program: u32, program_interface: enums::ProgramInterface, name: *const i8) -> u32 {
(self.get_program_resource_index_p)(program, program_interface as u32, name)
}

pub fn get_program_resource_location(&self, program: u32, program_interface: enums::ProgramInterface, name: *const i8) -> i32 {
(self.get_program_resource_location_p)(program, program_interface as u32, name)
}

pub fn get_program_resource_name(&self, program: u32, program_interface: enums::ProgramInterface, index: u32, buf_size: i32, length: *mut i32, name: *mut i8) {
(self.get_program_resource_name_p)(program, program_interface as u32, index, buf_size, length, name)
}

pub fn get_program_resourceiv(&self, program: u32, program_interface: enums::ProgramInterface, index: u32, prop_count: i32, props: *const enums::ProgramResourceProperty, count: i32, length: *mut i32, params: *mut i32) {
(self.get_program_resourceiv_p)(program, program_interface as u32, index, prop_count, props as *const u32, count, length, params)
}
...
pub fn get_query_objecti64v(&self, id: u32, pname: enums::QueryObjectParameterName, params: *mut i64) {
(self.get_query_objecti64v_p)(id, pname as u32, params)
}

pub fn get_query_objectiv(&self, id: u32, pname: enums::QueryObjectParameterName, params: *mut i32) {
(self.get_query_objectiv_p)(id, pname as u32, params)
}

pub fn get_query_objectui64v(&self, id: u32, pname: enums::QueryObjectParameterName, params: *mut u64) {
(self.get_query_objectui64v_p)(id, pname as u32, params)
}

pub fn get_query_objectuiv(&self, id: u32, pname: enums::QueryObjectParameterName, params: *mut u32) {
(self.get_query_objectuiv_p)(id, pname as u32, params)
}

pub fn get_queryiv(&self, target: enums::QueryTarget, pname: enums::QueryParameterName, params: *mut i32) {
(self.get_queryiv_p)(target as u32, pname as u32, params)
}

pub fn get_renderbuffer_parameteriv(&self, target: enums::RenderbufferTarget, pname: enums::RenderbufferParameterName, params: *mut i32) {
(self.get_renderbuffer_parameteriv_p)(target as u32, pname as u32, params)
}

pub fn get_sampler_parameter_iiv(&self, sampler: u32, pname: enums::SamplerParameterI, params: *mut i32) {
(self.get_sampler_parameter_iiv_p)(sampler, pname as u32, params)
}

pub fn get_sampler_parameter_iuiv(&self, sampler: u32, pname: enums::SamplerParameterI, params: *mut u32) {
(self.get_sampler_parameter_iuiv_p)(sampler, pname as u32, params)
}

pub fn get_sampler_parameterfv(&self, sampler: u32, pname: enums::SamplerParameterF, params: *mut f32) {
(self.get_sampler_parameterfv_p)(sampler, pname as u32, params)
}

pub fn get_sampler_parameteriv(&self, sampler: u32, pname: enums::SamplerParameterI, params: *mut i32) {
...
pub fn get_shader_precision_format(&self, shadertype: enums::ShaderType, precisiontype: enums::PrecisionType, range: *mut i32, precision: *mut i32) {
(self.get_shader_precision_format_p)(shadertype as u32, precisiontype as u32, range, precision)
}
...
pub fn get_synciv(&self, sync: *mut c_void, pname: enums::SyncParameterName, count: i32, length: *mut i32, values: *mut i32) {
(self.get_synciv_p)(sync, pname as u32, count, length, values)
}

pub fn get_tex_envfv(&self, target: enums::TextureEnvTarget, pname: enums::TextureEnvParameter, params: *mut f32) {
(self.get_tex_envfv_p)(target as u32, pname as u32, params)
}

pub fn get_tex_enviv(&self, target: enums::TextureEnvTarget, pname: enums::TextureEnvParameter, params: *mut i32) {
(self.get_tex_enviv_p)(target as u32, pname as u32, params)
}

pub fn get_tex_envxv(&self, target: enums::TextureEnvTarget, pname: enums::TextureEnvParameter, params: *mut i32) {
(self.get_tex_envxv_p)(target as u32, pname as u32, params)
}

pub fn get_tex_image(&self, target: enums::TextureTarget, level: i32, format: enums::PixelFormat, type_: enums::PixelType, pixels: *mut c_void) {
(self.get_tex_image_p)(target as u32, level, format as u32, type_ as u32, pixels)
}

pub fn get_tex_level_parameterfv(&self, target: enums::TextureTarget, level: i32, pname: enums::GetTextureParameter, params: *mut f32) {
(self.get_tex_level_parameterfv_p)(target as u32, level, pname as u32, params)
}

pub fn get_tex_level_parameteriv(&self, target: enums::TextureTarget, level: i32, pname: enums::GetTextureParameter, params: *mut i32) {
(self.get_tex_level_parameteriv_p)(target as u32, level, pname as u32, params)
}

pub fn get_tex_parameter_iiv(&self, target: enums::TextureTarget, pname: enums::GetTextureParameter, params: *mut i32) {
(self.get_tex_parameter_iiv_p)(target as u32, pname as u32, params)
}

pub fn get_tex_parameter_iuiv(&self, target: enums::TextureTarget, pname: enums::GetTextureParameter, params: *mut u32) {
(self.get_tex_parameter_iuiv_p)(target as u32, pname as u32, params)
}

pub fn get_tex_parameterfv(&self, target: enums::TextureTarget, pname: enums::GetTextureParameter, params: *mut f32) {
(self.get_tex_parameterfv_p)(target as u32, pname as u32, params)
}

pub fn get_tex_parameteriv(&self, target: enums::TextureTarget, pname: enums::GetTextureParameter, params: *mut i32) {
(self.get_tex_parameteriv_p)(target as u32, pname as u32, params)
}

pub fn get_tex_parameterxv(&self, target: enums::TextureTarget, pname: enums::GetTextureParameter, params: *mut i32) {
(self.get_tex_parameterxv_p)(target as u32, pname as u32, params)
}

pub fn get_transform_feedback_varying(&self, program: u32, index: u32, buf_size: i32, length: *mut i32, size: *mut i32, type_: *mut enums::AttributeType, name: *mut i8) {
(self.get_transform_feedback_varying_p)(program, index, buf_size, length, size, type_ as *mut u32, name)
}
...
pub fn get_vertex_attrib_iiv(&self, index: u32, pname: enums::VertexAttribEnum, params: *mut i32) {
(self.get_vertex_attrib_iiv_p)(index, pname as u32, params)
}

pub fn get_vertex_attrib_iuiv(&self, index: u32, pname: enums::VertexAttribEnum, params: *mut u32) {
(self.get_vertex_attrib_iuiv_p)(index, pname as u32, params)
}

pub fn get_vertex_attrib_pointerv(&self, index: u32, pname: enums::VertexAttribPointerPropertyARB, pointer: *mut *mut c_void) {
(self.get_vertex_attrib_pointerv_p)(index, pname as u32, pointer)
}

pub fn get_vertex_attribdv(&self, index: u32, pname: enums::VertexAttribPropertyARB, params: *mut f64) {
(self.get_vertex_attribdv_p)(index, pname as u32, params)
}

pub fn get_vertex_attribfv(&self, index: u32, pname: enums::VertexAttribPropertyARB, params: *mut f32) {
(self.get_vertex_attribfv_p)(index, pname as u32, params)
}

pub fn get_vertex_attribiv(&self, index: u32, pname: enums::VertexAttribPropertyARB, params: *mut i32) {
...
pub fn invalidate_framebuffer(&self, target: enums::FramebufferTarget, num_attachments: i32, attachments: *const enums::InvalidateFramebufferAttachment) {
(self.invalidate_framebuffer_p)(target as u32, num_attachments, attachments as *const u32)
}

pub fn invalidate_sub_framebuffer(&self, target: enums::FramebufferTarget, num_attachments: i32, attachments: *const enums::InvalidateFramebufferAttachment, x: i32, y: i32, width: i32, height: i32) {
(self.invalidate_sub_framebuffer_p)(target as u32, num_attachments, attachments as *const u32, x, y, width, height)
}

pub fn is_buffer(&self, buffer: u32) -> enums::Boolean {
(self.is_buffer_p)(buffer).into()
}

pub fn is_enabled(&self, cap: enums::EnableCap) -> enums::Boolean {
(self.is_enabled_p)(cap as u32).into()
}

pub fn is_enabledi(&self, target: enums::EnableCap, index: u32) -> enums::Boolean {
(self.is_enabledi_p)(target as u32, index).into()
}

pub fn is_framebuffer(&self, framebuffer: u32) -> enums::Boolean {
(self.is_framebuffer_p)(framebuffer).into()
}

pub fn is_program(&self, program: u32) -> enums::Boolean {
(self.is_program_p)(program).into()
}

pub fn is_program_pipeline(&self, pipeline: u32) -> enums::Boolean {
(self.is_program_pipeline_p)(pipeline).into()
}

pub fn is_query(&self, id: u32) -> enums::Boolean {
(self.is_query_p)(id).into()
}

pub fn is_renderbuffer(&self, renderbuffer: u32) -> enums::Boolean {
(self.is_renderbuffer_p)(renderbuffer).into()
}

pub fn is_sampler(&self, sampler: u32) -> enums::Boolean {
(self.is_sampler_p)(sampler).into()
}

pub fn is_shader(&self, shader: u32) -> enums::Boolean {
(self.is_shader_p)(shader).into()
}

pub fn is_sync(&self, sync: *mut c_void) -> enums::Boolean {
(self.is_sync_p)(sync).into()
}

pub fn is_texture(&self, texture: u32) -> enums::Boolean {
(self.is_texture_p)(texture).into()
}

pub fn is_transform_feedback(&self, id: u32) -> enums::Boolean {
(self.is_transform_feedback_p)(id).into()
}

pub fn is_vertex_array(&self, array: u32) -> enums::Boolean {
(self.is_vertex_array_p)(array).into()
}
...
pub fn lightfv(&self, light: enums::LightName, pname: enums::LightParameter, params: *const f32) {
...
pub fn lightxv(&self, light: enums::LightName, pname: enums::LightParameter, params: *const i32) {
...
pub fn map_buffer(&self, target: enums::BufferTargetARB, access: enums::BufferAccessARB) -> *mut c_void {
(self.map_buffer_p)(target as u32, access as u32)
}

pub fn map_buffer_range(&self, target: enums::BufferTargetARB, offset: isize, length: isize, access: enums::MapBufferAccessMask) -> *mut c_void {
(self.map_buffer_range_p)(target as u32, offset, length, access as u32)
}

pub fn materialf(&self, face: enums::TriangleFace, pname: enums::MaterialParameter, param: f32) {
(self.materialf_p)(face as u32, pname as u32, param)
}

pub fn materialfv(&self, face: enums::TriangleFace, pname: enums::MaterialParameter, params: *const f32) {
(self.materialfv_p)(face as u32, pname as u32, params)
}

pub fn materialx(&self, face: enums::TriangleFace, pname: enums::MaterialParameter, param: i32) {
(self.materialx_p)(face as u32, pname as u32, param)
}

pub fn materialxv(&self, face: enums::TriangleFace, pname: enums::MaterialParameter, param: *const i32) {
...
pub fn multi_draw_arrays(&self, mode: enums::PrimitiveType, first: *const i32, count: *const i32, drawcount: i32) {
(self.multi_draw_arrays_p)(mode as u32, first, count, drawcount)
}

pub fn multi_draw_elements(&self, mode: enums::PrimitiveType, count: *const i32, type_: enums::DrawElementsType, indices: *const *const c_void, drawcount: i32) {
(self.multi_draw_elements_p)(mode as u32, count, type_ as u32, indices, drawcount)
}

pub fn multi_draw_elements_base_vertex(&self, mode: enums::PrimitiveType, count: *const i32, type_: enums::DrawElementsType, indices: *const *const c_void, drawcount: i32, basevertex: *const i32) {
(self.multi_draw_elements_base_vertex_p)(mode as u32, count, type_ as u32, indices, drawcount, basevertex)
}
...
pub fn multi_tex_coord_p1ui(&self, texture: enums::TextureUnit, type_: enums::TexCoordPointerType, coords: u32) {
(self.multi_tex_coord_p1ui_p)(texture as u32, type_ as u32, coords)
}

pub fn multi_tex_coord_p1uiv(&self, texture: enums::TextureUnit, type_: enums::TexCoordPointerType, coords: *const u32) {
(self.multi_tex_coord_p1uiv_p)(texture as u32, type_ as u32, coords)
}

pub fn multi_tex_coord_p2ui(&self, texture: enums::TextureUnit, type_: enums::TexCoordPointerType, coords: u32) {
(self.multi_tex_coord_p2ui_p)(texture as u32, type_ as u32, coords)
}

pub fn multi_tex_coord_p2uiv(&self, texture: enums::TextureUnit, type_: enums::TexCoordPointerType, coords: *const u32) {
(self.multi_tex_coord_p2uiv_p)(texture as u32, type_ as u32, coords)
}

pub fn multi_tex_coord_p3ui(&self, texture: enums::TextureUnit, type_: enums::TexCoordPointerType, coords: u32) {
(self.multi_tex_coord_p3ui_p)(texture as u32, type_ as u32, coords)
}

pub fn multi_tex_coord_p3uiv(&self, texture: enums::TextureUnit, type_: enums::TexCoordPointerType, coords: *const u32) {
(self.multi_tex_coord_p3uiv_p)(texture as u32, type_ as u32, coords)
}

pub fn multi_tex_coord_p4ui(&self, texture: enums::TextureUnit, type_: enums::TexCoordPointerType, coords: u32) {
(self.multi_tex_coord_p4ui_p)(texture as u32, type_ as u32, coords)
}

pub fn multi_tex_coord_p4uiv(&self, texture: enums::TextureUnit, type_: enums::TexCoordPointerType, coords: *const u32) {
...
pub fn normal_pointer(&self, type_: enums::NormalPointerType, stride: i32, pointer: *const c_void) {
(self.normal_pointer_p)(type_ as u32, stride, pointer)
}

pub fn object_label(&self, identifier: enums::ObjectIdentifier, name: u32, length: i32, label: *const i8) {
...
pub fn program_parameteri(&self, program: u32, pname: enums::ProgramParameterPName, value: i32) {
...
pub fn program_uniform_matrix2fv(&self, program: u32, location: i32, count: i32, transpose: enums::Boolean, value: *const f32) {
(self.program_uniform_matrix2fv_p)(program, location, count, transpose as u8, value)
}

pub fn program_uniform_matrix2x3fv(&self, program: u32, location: i32, count: i32, transpose: enums::Boolean, value: *const f32) {
(self.program_uniform_matrix2x3fv_p)(program, location, count, transpose as u8, value)
}

pub fn program_uniform_matrix2x4fv(&self, program: u32, location: i32, count: i32, transpose: enums::Boolean, value: *const f32) {
(self.program_uniform_matrix2x4fv_p)(program, location, count, transpose as u8, value)
}

pub fn program_uniform_matrix3fv(&self, program: u32, location: i32, count: i32, transpose: enums::Boolean, value: *const f32) {
(self.program_uniform_matrix3fv_p)(program, location, count, transpose as u8, value)
}

pub fn program_uniform_matrix3x2fv(&self, program: u32, location: i32, count: i32, transpose: enums::Boolean, value: *const f32) {
(self.program_uniform_matrix3x2fv_p)(program, location, count, transpose as u8, value)
}

pub fn program_uniform_matrix3x4fv(&self, program: u32, location: i32, count: i32, transpose: enums::Boolean, value: *const f32) {
(self.program_uniform_matrix3x4fv_p)(program, location, count, transpose as u8, value)
}

pub fn program_uniform_matrix4fv(&self, program: u32, location: i32, count: i32, transpose: enums::Boolean, value: *const f32) {
(self.program_uniform_matrix4fv_p)(program, location, count, transpose as u8, value)
}

pub fn program_uniform_matrix4x2fv(&self, program: u32, location: i32, count: i32, transpose: enums::Boolean, value: *const f32) {
(self.program_uniform_matrix4x2fv_p)(program, location, count, transpose as u8, value)
}

pub fn program_uniform_matrix4x3fv(&self, program: u32, location: i32, count: i32, transpose: enums::Boolean, value: *const f32) {
...
pub fn push_debug_group(&self, source: enums::DebugSource, id: u32, length: i32, message: *const i8) {
...
pub fn read_pixels(&self, x: i32, y: i32, width: i32, height: i32, format: enums::PixelFormat, type_: enums::PixelType, pixels: *mut c_void) {
(self.read_pixels_p)(x, y, width, height, format as u32, type_ as u32, pixels)
}

pub fn readn_pixels(&self, x: i32, y: i32, width: i32, height: i32, format: enums::PixelFormat, type_: enums::PixelType, buf_size: i32, data: *mut c_void) {
(self.readn_pixels_p)(x, y, width, height, format as u32, type_ as u32, buf_size, data)
}
...
pub fn renderbuffer_storage(&self, target: enums::RenderbufferTarget, internalformat: enums::InternalFormat, width: i32, height: i32) {
(self.renderbuffer_storage_p)(target as u32, internalformat as u32, width, height)
}

pub fn renderbuffer_storage_multisample(&self, target: enums::RenderbufferTarget, samples: i32, internalformat: enums::InternalFormat, width: i32, height: i32) {
(self.renderbuffer_storage_multisample_p)(target as u32, samples, internalformat as u32, width, height)
}
...
pub fn sample_coverage(&self, value: f32, invert: enums::Boolean) {
(self.sample_coverage_p)(value, invert as u8)
}

pub fn sample_coveragex(&self, value: i32, invert: enums::Boolean) {
...
pub fn sampler_parameter_iiv(&self, sampler: u32, pname: enums::SamplerParameterI, param: *const i32) {
(self.sampler_parameter_iiv_p)(sampler, pname as u32, param)
}

pub fn sampler_parameter_iuiv(&self, sampler: u32, pname: enums::SamplerParameterI, param: *const u32) {
...
pub fn sampler_parameterfv(&self, sampler: u32, pname: enums::SamplerParameterF, param: *const f32) {
...
pub fn sampler_parameteriv(&self, sampler: u32, pname: enums::SamplerParameterI, param: *const i32) {
...
pub fn stencil_func_separate(&self, face: enums::TriangleFace, func: enums::StencilFunction, ref_: i32, mask: u32) {
...
pub fn stencil_op(&self, fail: enums::StencilOp, zfail: enums::StencilOp, zpass: enums::StencilOp) {
(self.stencil_op_p)(fail as u32, zfail as u32, zpass as u32)
}

pub fn stencil_op_separate(&self, face: enums::TriangleFace, sfail: enums::StencilOp, dpfail: enums::StencilOp, dppass: enums::StencilOp) {
(self.stencil_op_separate_p)(face as u32, sfail as u32, dpfail as u32, dppass as u32)
}

pub fn tex_buffer(&self, target: enums::TextureTarget, internalformat: enums::SizedInternalFormat, buffer: u32) {
(self.tex_buffer_p)(target as u32, internalformat as u32, buffer)
}

pub fn tex_buffer_range(&self, target: enums::TextureTarget, internalformat: enums::SizedInternalFormat, buffer: u32, offset: isize, size: isize) {
...
pub fn tex_coord_pointer(&self, size: i32, type_: enums::TexCoordPointerType, stride: i32, pointer: *const c_void) {
(self.tex_coord_pointer_p)(size, type_ as u32, stride, pointer)
}

pub fn tex_envf(&self, target: enums::TextureEnvTarget, pname: enums::TextureEnvParameter, param: f32) {
(self.tex_envf_p)(target as u32, pname as u32, param)
}

pub fn tex_envfv(&self, target: enums::TextureEnvTarget, pname: enums::TextureEnvParameter, params: *const f32) {
(self.tex_envfv_p)(target as u32, pname as u32, params)
}

pub fn tex_envi(&self, target: enums::TextureEnvTarget, pname: enums::TextureEnvParameter, param: i32) {
(self.tex_envi_p)(target as u32, pname as u32, param)
}

pub fn tex_enviv(&self, target: enums::TextureEnvTarget, pname: enums::TextureEnvParameter, params: *const i32) {
(self.tex_enviv_p)(target as u32, pname as u32, params)
}

pub fn tex_envx(&self, target: enums::TextureEnvTarget, pname: enums::TextureEnvParameter, param: i32) {
(self.tex_envx_p)(target as u32, pname as u32, param)
}

pub fn tex_envxv(&self, target: enums::TextureEnvTarget, pname: enums::TextureEnvParameter, params: *const i32) {
(self.tex_envxv_p)(target as u32, pname as u32, params)
}

pub fn tex_image1_d(&self, target: enums::TextureTarget, level: i32, internalformat: enums::InternalFormat, width: i32, border: i32, format: enums::PixelFormat, type_: enums::PixelType, pixels: *const c_void) {
(self.tex_image1_d_p)(target as u32, level, internalformat as i32, width, border, format as u32, type_ as u32, pixels)
}

pub fn tex_image2_d(&self, target: enums::TextureTarget, level: i32, internalformat: enums::InternalFormat, width: i32, height: i32, border: i32, format: enums::PixelFormat, type_: enums::PixelType, pixels: *const c_void) {
(self.tex_image2_d_p)(target as u32, level, internalformat as i32, width, height, border, format as u32, type_ as u32, pixels)
}

pub fn tex_image2_d_multisample(&self, target: enums::TextureTarget, samples: i32, internalformat: enums::InternalFormat, width: i32, height: i32, fixedsamplelocations: enums::Boolean) {
(self.tex_image2_d_multisample_p)(target as u32, samples, internalformat as u32, width, height, fixedsamplelocations as u8)
}

pub fn tex_image3_d(&self, target: enums::TextureTarget, level: i32, internalformat: enums::InternalFormat, width: i32, height: i32, depth: i32, border: i32, format: enums::PixelFormat, type_: enums::PixelType, pixels: *const c_void) {
(self.tex_image3_d_p)(target as u32, level, internalformat as i32, width, height, depth, border, format as u32, type_ as u32, pixels)
}

pub fn tex_image3_d_multisample(&self, target: enums::TextureTarget, samples: i32, internalformat: enums::InternalFormat, width: i32, height: i32, depth: i32, fixedsamplelocations: enums::Boolean) {
(self.tex_image3_d_multisample_p)(target as u32, samples, internalformat as u32, width, height, depth, fixedsamplelocations as u8)
}

pub fn tex_parameter_iiv(&self, target: enums::TextureTarget, pname: enums::TextureParameterName, params: *const i32) {
(self.tex_parameter_iiv_p)(target as u32, pname as u32, params)
}

pub fn tex_parameter_iuiv(&self, target: enums::TextureTarget, pname: enums::TextureParameterName, params: *const u32) {
(self.tex_parameter_iuiv_p)(target as u32, pname as u32, params)
}

pub fn tex_parameterf(&self, target: enums::TextureTarget, pname: enums::TextureParameterName, param: f32) {
(self.tex_parameterf_p)(target as u32, pname as u32, param)
}

pub fn tex_parameterfv(&self, target: enums::TextureTarget, pname: enums::TextureParameterName, params: *const f32) {
(self.tex_parameterfv_p)(target as u32, pname as u32, params)
}

pub fn tex_parameteri(&self, target: enums::TextureTarget, pname: enums::TextureParameterName, param: i32) {
(self.tex_parameteri_p)(target as u32, pname as u32, param)
}

pub fn tex_parameteriv(&self, target: enums::TextureTarget, pname: enums::TextureParameterName, params: *const i32) {
(self.tex_parameteriv_p)(target as u32, pname as u32, params)
}

pub fn tex_parameterx(&self, target: enums::TextureTarget, pname: enums::GetTextureParameter, param: i32) {
(self.tex_parameterx_p)(target as u32, pname as u32, param)
}

pub fn tex_parameterxv(&self, target: enums::TextureTarget, pname: enums::GetTextureParameter, params: *const i32) {
(self.tex_parameterxv_p)(target as u32, pname as u32, params)
}

pub fn tex_storage2_d(&self, target: enums::TextureTarget, levels: i32, internalformat: enums::SizedInternalFormat, width: i32, height: i32) {
(self.tex_storage2_d_p)(target as u32, levels, internalformat as u32, width, height)
}

pub fn tex_storage2_d_multisample(&self, target: enums::TextureTarget, samples: i32, internalformat: enums::SizedInternalFormat, width: i32, height: i32, fixedsamplelocations: enums::Boolean) {
(self.tex_storage2_d_multisample_p)(target as u32, samples, internalformat as u32, width, height, fixedsamplelocations as u8)
}

pub fn tex_storage3_d(&self, target: enums::TextureTarget, levels: i32, internalformat: enums::SizedInternalFormat, width: i32, height: i32, depth: i32) {
(self.tex_storage3_d_p)(target as u32, levels, internalformat as u32, width, height, depth)
}

pub fn tex_storage3_d_multisample(&self, target: enums::TextureTarget, samples: i32, internalformat: enums::SizedInternalFormat, width: i32, height: i32, depth: i32, fixedsamplelocations: enums::Boolean) {
(self.tex_storage3_d_multisample_p)(target as u32, samples, internalformat as u32, width, height, depth, fixedsamplelocations as u8)
}

pub fn tex_sub_image1_d(&self, target: enums::TextureTarget, level: i32, xoffset: i32, width: i32, format: enums::PixelFormat, type_: enums::PixelType, pixels: *const c_void) {
(self.tex_sub_image1_d_p)(target as u32, level, xoffset, width, format as u32, type_ as u32, pixels)
}

pub fn tex_sub_image2_d(&self, target: enums::TextureTarget, level: i32, xoffset: i32, yoffset: i32, width: i32, height: i32, format: enums::PixelFormat, type_: enums::PixelType, pixels: *const c_void) {
(self.tex_sub_image2_d_p)(target as u32, level, xoffset, yoffset, width, height, format as u32, type_ as u32, pixels)
}

pub fn tex_sub_image3_d(&self, target: enums::TextureTarget, level: i32, xoffset: i32, yoffset: i32, zoffset: i32, width: i32, height: i32, depth: i32, format: enums::PixelFormat, type_: enums::PixelType, pixels: *const c_void) {
(self.tex_sub_image3_d_p)(target as u32, level, xoffset, yoffset, zoffset, width, height, depth, format as u32, type_ as u32, pixels)
}

pub fn transform_feedback_varyings(&self, program: u32, count: i32, varyings: *const *const i8, buffer_mode: enums::TransformFeedbackBufferMode) {
...
pub fn uniform_matrix2fv(&self, location: i32, count: i32, transpose: enums::Boolean, value: *const f32) {
(self.uniform_matrix2fv_p)(location, count, transpose as u8, value)
}

pub fn uniform_matrix2x3fv(&self, location: i32, count: i32, transpose: enums::Boolean, value: *const f32) {
(self.uniform_matrix2x3fv_p)(location, count, transpose as u8, value)
}

pub fn uniform_matrix2x4fv(&self, location: i32, count: i32, transpose: enums::Boolean, value: *const f32) {
(self.uniform_matrix2x4fv_p)(location, count, transpose as u8, value)
}

pub fn uniform_matrix3fv(&self, location: i32, count: i32, transpose: enums::Boolean, value: *const f32) {
(self.uniform_matrix3fv_p)(location, count, transpose as u8, value)
}

pub fn uniform_matrix3x2fv(&self, location: i32, count: i32, transpose: enums::Boolean, value: *const f32) {
(self.uniform_matrix3x2fv_p)(location, count, transpose as u8, value)
}

pub fn uniform_matrix3x4fv(&self, location: i32, count: i32, transpose: enums::Boolean, value: *const f32) {
(self.uniform_matrix3x4fv_p)(location, count, transpose as u8, value)
}

pub fn uniform_matrix4fv(&self, location: i32, count: i32, transpose: enums::Boolean, value: *const f32) {
(self.uniform_matrix4fv_p)(location, count, transpose as u8, value)
}

pub fn uniform_matrix4x2fv(&self, location: i32, count: i32, transpose: enums::Boolean, value: *const f32) {
(self.uniform_matrix4x2fv_p)(location, count, transpose as u8, value)
}

pub fn uniform_matrix4x3fv(&self, location: i32, count: i32, transpose: enums::Boolean, value: *const f32) {
(self.uniform_matrix4x3fv_p)(location, count, transpose as u8, value)
}

pub fn unmap_buffer(&self, target: enums::BufferTargetARB) -> enums::Boolean {
(self.unmap_buffer_p)(target as u32).into()
}
...
pub fn use_program_stages(&self, pipeline: u32, stages: enums::UseProgramStageMask, program: u32) {
...
pub fn vertex_attrib_format(&self, attribindex: u32, size: i32, type_: enums::VertexAttribType, normalized: enums::Boolean, relativeoffset: u32) {
(self.vertex_attrib_format_p)(attribindex, size, type_ as u32, normalized as u8, relativeoffset)
}
...
pub fn vertex_attrib_i_format(&self, attribindex: u32, size: i32, type_: enums::VertexAttribIType, relativeoffset: u32) {
(self.vertex_attrib_i_format_p)(attribindex, size, type_ as u32, relativeoffset)
}

pub fn vertex_attrib_i_pointer(&self, index: u32, size: i32, type_: enums::VertexAttribIType, stride: i32, pointer: *const c_void) {
(self.vertex_attrib_i_pointer_p)(index, size, type_ as u32, stride, pointer)
}

pub fn vertex_attrib_p1ui(&self, index: u32, type_: enums::VertexAttribPointerType, normalized: enums::Boolean, value: u32) {
(self.vertex_attrib_p1ui_p)(index, type_ as u32, normalized as u8, value)
}

pub fn vertex_attrib_p1uiv(&self, index: u32, type_: enums::VertexAttribPointerType, normalized: enums::Boolean, value: *const u32) {
(self.vertex_attrib_p1uiv_p)(index, type_ as u32, normalized as u8, value)
}

pub fn vertex_attrib_p2ui(&self, index: u32, type_: enums::VertexAttribPointerType, normalized: enums::Boolean, value: u32) {
(self.vertex_attrib_p2ui_p)(index, type_ as u32, normalized as u8, value)
}

pub fn vertex_attrib_p2uiv(&self, index: u32, type_: enums::VertexAttribPointerType, normalized: enums::Boolean, value: *const u32) {
(self.vertex_attrib_p2uiv_p)(index, type_ as u32, normalized as u8, value)
}

pub fn vertex_attrib_p3ui(&self, index: u32, type_: enums::VertexAttribPointerType, normalized: enums::Boolean, value: u32) {
(self.vertex_attrib_p3ui_p)(index, type_ as u32, normalized as u8, value)
}

pub fn vertex_attrib_p3uiv(&self, index: u32, type_: enums::VertexAttribPointerType, normalized: enums::Boolean, value: *const u32) {
(self.vertex_attrib_p3uiv_p)(index, type_ as u32, normalized as u8, value)
}

pub fn vertex_attrib_p4ui(&self, index: u32, type_: enums::VertexAttribPointerType, normalized: enums::Boolean, value: u32) {
(self.vertex_attrib_p4ui_p)(index, type_ as u32, normalized as u8, value)
}

pub fn vertex_attrib_p4uiv(&self, index: u32, type_: enums::VertexAttribPointerType, normalized: enums::Boolean, value: *const u32) {
(self.vertex_attrib_p4uiv_p)(index, type_ as u32, normalized as u8, value)
}

pub fn vertex_attrib_pointer(&self, index: u32, size: i32, type_: enums::VertexAttribPointerType, normalized: enums::Boolean, stride: i32, pointer: *const c_void) {
...
pub fn vertex_pointer(&self, size: i32, type_: enums::VertexPointerType, stride: i32, pointer: *const c_void) {
